...
<Callout type="warning" emoji="⚠️">
  如果你时常遇到插件无法使用的情况，可以考虑注册使用 Comflowy [云端版本](https://app.comflowy.com)，里面内置了 50 多款常用插件，注册即可使用
</Callout>
        ...
        <Tabs.Tab>
          ...
          <PhotoProvider>
            <PhotoView src="/install-comfyui-and-model/015.png">
                <img src="/install-comfyui-and-model/015.png" alt="" width="80%" style={{ display: "block", margin: "0 auto" }} className='rounded-lg'/>
            </PhotoView>
          </PhotoProvider>
          然后输入以下命令，启动 ComfyUI:
          ```shell copy
