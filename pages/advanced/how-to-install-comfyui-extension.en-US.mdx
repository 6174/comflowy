...
<Callout type="warning" emoji="⚠️">
  If you frequently encounter issues with extensions not working, consider signing up for the Comflowy [cloud version](https://app.comflowy.com). It comes with over 50 popular extensions built-in, ready to use upon registration.
</Callout>
