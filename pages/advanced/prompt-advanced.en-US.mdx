...
<Steps>
  ...
  First, you need to download and install the plugin. We'll use the ComfyUI Manager to help us with this operation. If you haven't installed ComfyUI Manager, you can check the [installing plugins](../../advanced/how-to-install-comfyui-extension) article.
