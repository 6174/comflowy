...
<PhotoProvider>
  <PhotoView src="/stable-diffusion-prompt/004.jpeg">
    <img src="/stable-diffusion-prompt/004.jpeg" alt="" />
  </PhotoView>
</PhotoProvider>
...
<Steps>
  ...
  <Callout type="warning" emoji="⚠️">
    需要注意：
    * 第一步导入完之后，最好点一下右侧面板的 refresh 按钮，这样可以确保模型已经加载成功。
    * 另外，Embedding 应该如何写，一般你在下载 Embedding 模型的时候，会有一个说明文档，里面会告诉你应该如何写 Embedding。比如这个 Tom Cruise embedding 的说明文档里就写要使用 embedding:ToCru69 这样的格式。
  </Callout>
  <br/>
  <PhotoProvider>
...
<br/>
<PhotoProvider>
  <PhotoView src="/stable-diffusion-prompt/006.jpeg">
    <img src="/stable-diffusion-prompt/006.jpeg" alt="" />
  </PhotoView>
</PhotoProvider>