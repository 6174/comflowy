...
* **Method two**: Influence the image generation by loading different Checkpoint models. This is a straightforward practice; you can check [Model Recommendations](../model) in the basic elective to learn about commonly used models in the industry.
