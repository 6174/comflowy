...
I will use the most common WenSheng diagram as an example to explain the overall architecture and working principle of Stable Diffusion.
...
<Callout type="info">
  You might be curious why it's "denoise" rather than other methods? You can refer to the section on [Advanced Stable Diffusion](../advanced/advanced-optional/stable-diffusion-advanced.zh-CN.mdx).
</Callout>
