...
- Nodes support collapsing.
- Support is available for setting the startup method, allowing manual control of floating-point precision and VAE precision. If there are issues with blurry or black images, consider setting the floating-point precision or VAE precision to FP32.
- Fixed some known bugs:
  - Fixed adaptation issues with Windows system notifications.
