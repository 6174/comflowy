...
### 🎉 Comflowy Cloud Version Update

**Product Update:**

1. Support the following extensions:
...
2. Fix the issue that the IC light related extension cannot run.

## 2024-08-30

### 🎉 Comflowy Open Source Version v0.2.3-alpha Release

**Product Update:**

1. Add Node Panel: To improve the efficiency of adding nodes, we have added a preview feature, allowing you to hover over the node name and preview the node effect in the pop-up window.
   <br />
   <PhotoProvider>
     <PhotoView src="/changelog/002.png">
       <img src="/changelog/002.png" alt="" className="rounded-lg" />
     </PhotoView>
   </PhotoProvider>
2. Node supports displaying developer annotation information, making it easier to use nodes.
   <br />
   <PhotoProvider>
     <PhotoView src="/changelog/003.png">
       <img src="/changelog/003.png" alt="" className="rounded-lg" />
     </PhotoView>
   </PhotoProvider>
3. Adapted the following nodes:
   - Show Text node
   - Audio node
4. Fixes:
   - Fixed the issue where the workflow name could not be saved after being modified
   - Fixed the UI display misalignment issue for some nodes
...
1. [Getting Started with Comflowy](https://www.comflowy.com/basics/new-to-comflowy)
...
- [Stable Diffusion Advanced](https://www.comflowy.com/advanced/stable-diffusion-advanced): Added the Stable Diffusion XL workflow, which can generate more refined images.
...
- [Install Plugins](https://www.comflowy.com/preparation-for-study/custom-nodes): Added the code to start ComfyUI. Thanks to Discord user **Tennisatw** for pointing out this issue.
