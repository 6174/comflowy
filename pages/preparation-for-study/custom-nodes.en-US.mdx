...
After clicking this feature, the plugin will automatically search for nodes that you haven't installed, and then load a list. Click the install button on the right side of the list to complete the installation. Of course, you can click Install Custom Nodes in the ComfyUI Manager menu to search and install by yourself. After the installation, you can disable or uninstall it:
<br/>
<PhotoProvider>
