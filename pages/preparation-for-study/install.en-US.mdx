...
<Tabs items={['Windows', 'Mac']}>
  ...
  <Tabs.Tab>
    ...
    <Steps>
      ...
      ```
      This step might take some time since it involves downloading and installing some stuff, so please be patient. Once "Successfully installed XXXXX" is displayed, this indicates that you have completed all the installations.
    </Steps>
...
<Tabs items={['VS Code(Recommend)', 'Terminal']}>
  ...
  <Tabs.Tab>
    ...
    <Steps>
      ...
      Open Terminal, type cd followed by a space, then paste the path you copied in the previous step. Be careful to add ComfyUI at the end before you hit enter. If all goes well, it should look like this:
      <PhotoProvider>
