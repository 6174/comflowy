...
The source code for ComfyUI can be found [here](https://github.com/comfyanonymous/ComfyUI), and the installation method is in the Readme. The author has written very detailed instructions, and you can also follow the Readme document for operations.

We will introduce two ways to install ComfyUI, and you can choose one based on your needs:
...
This section will primarily discuss how to install ComfyUI locally. If you want to install in the cloud, you can jump to [cloud installation](./optional/install-cloud).

## ComflowySpace

### Command Line Installation

There are two ways to install locally. The first method is the most universally applicable method, and the probability of encountering problems after installation is the lowest. But for users unfamiliar with command lines and coding, there can be some threshold. So this tutorial mainly introduces this method. If you encounter problems during installation, please join our [Discord](https://discord.gg/cj623WvcVx) group, we will do our best to help you.
...
* Optimized many experience issues with ComfyUI, making it more convenient and simple to use. A full introduction can be found [here](../space).
