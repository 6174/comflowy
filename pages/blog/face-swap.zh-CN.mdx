...
Workflow 很好搭建，首先你需要安装 [ReActor 插件](https://github.com/Gourieff/comfyui-reactor-node)。如果你不知道如何安装插件可以查阅我写的另一篇教程：[安装插件](../advanced/how-to-install-comfyui-extension)。
