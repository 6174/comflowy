...
Layer Diffusion supports the XL and 1.5 base models, and the Checkpoint model I downloaded here is [DreamShaper XL Lightning](https://www.comflowy.com/model/dream-shaper-xl-lightning).
