...
* Batch_Size：在 empty latent image 节点中，有一个 batch 的参数项，我这里设置了 4，这就意味着最后模型会连续生成 4 张图。可以看到加入 LoRA 模型后，同时生成4张图，风格都是很统一的。
...
### 1. 新古典主义风格：[neoclassic] (https://civitai.com/models/97680/neoclassic-interior) 
...
### 2. 日式侘寂风：[Japan style interior design style] (https://civitai.com/models/182703/japan-style-interior-design-style)
...
### 3. 奶油风：[Cream style interior design] (https://civitai.com/models/175123/cream-style-interior-design-style)
...
### 4. 现代风格：[Modern Grey Style Interior ] (https://civitai.com/models/115175/ormodern-grey-style-interior-design)
...
- Checkpoint：首先下载inpainting的模型 [Dreamshaper 8-inpainting] (https://civitai.com/models/4384?modelVersionId=131004)，并将其放到 ComfyUI 里的 models/checkpoints 文件夹内。在checkpoint节点中更换到这个模型。
...
随着我们深入探讨了ComfyUI在室内设计领域的应用及其潜力，你可能对这个创新的 AI 生图工具产生了浓厚的兴趣。想要了解更多关于 ComfyUI 的信息，体验它是如何革新设计流程的，敬请访问 [Comflowy 介绍 – Comflowy] (https://www.comflowy.com/)。在那里，你将发现更多的应用案例，和详细的 ComfyUI 使用指南。
