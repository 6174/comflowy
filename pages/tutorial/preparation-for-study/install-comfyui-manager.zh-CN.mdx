...
<br/>
<PhotoProvider>
  <PhotoView src="/install-comfyui-and-model/comfyui-manager.png">
      <img src="/install-comfyui-and-model/comfyui-manager.png" alt="" width="100%" style={{ display: "block", margin: "0 auto" }} className="rounded-lg"/>
  </PhotoView>
</PhotoProvider>
...
### 下载模型
首先点击顶部的 Manager 按钮，会弹出这样的一个框，接着我们再点击中间的「Install Models」按钮：
<br/>
<PhotoProvider>
