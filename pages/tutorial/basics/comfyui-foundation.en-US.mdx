...
<Callout type="warning" emoji="⚠️">
  Before starting this chapter, please make sure that you have completed the installation of ComfyUI , and have downloaded the Stable Diffusion v1.5 or Stable Diffusion XL model. Also, ensure that the model files are placed in the appropriate folder.
...
<Tabs items={['Comflowy', 'ComfyUI']}>
  <Tabs.Tab>
  If you are using Comflowy, when you open the application, you will be greeted with an interface like this one. If you're using our cloud version, you should see a similar interface.
  <br/>
  <PhotoProvider>
...
<PhotoProvider>
  <PhotoView src="/comfyui-foundation/005.jpg">
    <img src="/comfyui-foundation/005.jpg" alt="" width="70%" style={{ display: "block", margin: "0 auto" }} className='rounded-lg'/>
  </PhotoView>
</PhotoProvider>
