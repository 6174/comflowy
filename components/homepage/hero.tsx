      ...
      <div className="hero-content">
        <div className="text-content">
          ...
          <div className="cta-section">
            <p className="subtitle">For Everyone from Creators to Entrepreneurs</p>
            <button className="sign-up-btn" onClick={handleSignUp}>
              <svg width="34" height="32" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="sign-up-btn-svg">
